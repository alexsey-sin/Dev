...
# MTSWebSSO cookie берем при открытой сессии в личном кабинете
...
# 200
# {
    # "client_name":"7604350152_79109630404",
    # "client_id":"cVAVjTPcRSk3xp0p3XzQcUQzz9pO0IyOiUpb6XGstUj0YUlyLkQsIJIzVcgRFgia@app.b2b.mts.ru",
    # "client_secret":"",
    # "access_token":"AQIC5wM2LY4SfcyA5VXFqpPaAodKeLOv3agBveXc_tu1LdQ.*AAJTSQACMDQAAlNLABM0NjUwMDAyNDQ5MzgzOTc2MjY2AAJTMQACMjU.*",
    # "token_type":"Bearer",
    # "refresh_token":"VwwG8g2i1RHvmLSEp4xlphP5UDflLHvmIXo5tPqUfMwjFEijDJf5RuuM1gwobh98"
# }
# client_id, client_secret, refresh_token – выдаются единожды и используются только для обновления access_token.
# c:\Dev\parsing_MTS>
