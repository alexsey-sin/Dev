# Generated by Django 3.0.5 on 2022-01-17 21:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('domconnect', '0003_auto_20220119_1523'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='assigned_by_id',
            field=models.IntegerField(blank=True, default=0, verbose_name='ASSIGNED_BY_ID'),
        ),
        migrations.AlterField(
            model_name='domconnectcrmlid',
            name='create_date',
        ...
        migrations.AlterField(
            model_name='domconnectcrmlid',
            name='id_lid',
            field=models.IntegerField(blank=True, default=0, unique=True, verbose_name='ID'),
        ),
        migrations.AlterField(
            model_name='domconnectcrmlid',
            name='modify_date',
        ...
        migrations.AlterField(
            model_name='domconnectcrmlid',
            name='source_id',
            field=models.IntegerField(blank=True, default=0, verbose_name='Источник'),
        ),
        migrations.AlterField(
            model_name='domconnectcrmlid',
            name='status_id',
